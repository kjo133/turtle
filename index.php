     ...
     <section class="main" id="about">
       <div class="wrapper row">
         <div class="medium-12 column">
          <h1>ABOUT</h1>
          <p>We are The Sprinting Turtles! <br /> Rock band from Washington DC formed while Kevin and Justin were studying at Virginia Tech.  After graduating Justin and Kevin moved to the Washington DC area and wanted to continue to play music.  We still bring the same goofy energy to our shows today and it is always a blast getting the crowd involved and singing along with us.  Check out our music and who we are!</p>
          <br />
            <div class="row">
              <div class="col-sm-6 bandMember">
            ...
            <br />
            <br />
            <h1 id="schedule">2019 Schedule</h1>
            <p>January 26 - Tucked Away Brewery</p>
            <p>March 7 - Light Horse</p>
            <p>December 7 - Paradise Springs</p>
            ...
            <p>
              ...
              PAST VENUES <br/>
              Alley Cat <br /> 
              Arlinton County Fair <br />
              Auld Shebeen <br />
              Boomerang Pirate Ship <br />
              Cowboy Cafe <br />
              Gypsy Sallys <br />
              Jammin Java <br />
              Tysons Biergarten <br />
              Westover Beer Garden <br />
